...
export class SearchService {
  ...
  async substructure(dto: SubstructureSearchDto) {
    return this.forward(() => this.http.post(`${this.baseUrl}/search/substructure`, dto));
  }

  async similarity(dto: SimilaritySearchDto) {
    return this.forward(() => this.http.post(`${this.baseUrl}/search/similarity`, dto));
  }
